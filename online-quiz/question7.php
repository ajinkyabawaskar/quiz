...
<body>
    <div class="container mt-5">
        <div class="row">
            ...
            Which of the following allowed the investors to buy mutual fund through digital wallets?
                ...
                if(isset($_POST["answer"])) {
                    ...
                    $name = $_SESSION['name'];
                    $ans = $_POST['answer'];
                    $sql = "UPDATE verifiedtable SET ans7 = '$ans' WHERE verified = '$name'";
