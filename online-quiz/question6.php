...
<body>
    <div class="container mt-5">
        <div class="row">
            ...
            What is the maximum amount that an account holder of Punjab and Maharashtra Co-operative Bank Limited (PMC) can withdraw after prohibition on business transaction from RBI?
                ...
                if(isset($_POST["answer"])) {
                    ...
                    $name = $_SESSION['name'];
                    $ans = $_POST['answer'];
                    $sql = "UPDATE verifiedtable SET ans6 = '$ans' WHERE verified = '$name'";
