...
<body>
    <div class="container mt-5">
        <div class="row">
            ...
            Which firm bought engineering and design teams for $1.1 billion deal from HTC?
                ...
                if(isset($_POST["answer"])) {
                    ...
                    $name = $_SESSION['name'];
                    $ans = $_POST['answer'];
                    $sql = "UPDATE verifiedtable SET ans16 = '$ans' WHERE verified = '$name'";
                    if ($conn->query($sql) === TRUE) {
                        header('Location: question17.php');
                    }
                    else {
