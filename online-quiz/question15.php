...
<body>
    <div class="container mt-5">
        <div class="row">
            ...
            Name the India's Non Banking Financial Company which will acquire up to 58.2% stake in Sri Lanka's Ideal Finance for LKR 2 billion.
                ...
                if(isset($_POST["answer"])) {
                    ...
                    $name = $_SESSION['name'];
                    $ans = $_POST['answer'];
                    $sql = "UPDATE verifiedtable SET ans15 = '$ans' WHERE verified = '$name'";
                    if ($conn->query($sql) === TRUE) {
                        header('Location: question16.php');
                    }
                    else {
                        header('Location: question15.php');
                    }
                }
                ?>
            </div>
