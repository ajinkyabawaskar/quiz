...
<body>
    <div class="container mt-5">
        <div class="row">
            ...
            Which of the following company has signed an agreement with Bank of Baroda to be the preferred financier for its dealers and consumers?
                ...
                if(isset($_POST["answer"])) {
                    ...
                    $name = $_SESSION['name'];
                    $ans = $_POST['answer'];
                    $sql = "UPDATE verifiedtable SET ans4 = '$ans' WHERE verified = '$name'";
