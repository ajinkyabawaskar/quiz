...
<body>
    <div class="container mt-5">
        <div class="row">
            ...
            _______ is a form of digital marketing that describes the use of the social web and social media (e.g. social networks, online communities, blogs or wikis) or any online collaborative technology for marketing activities, be it sales, public relations, research, distribution or customer service.
                ...
                if(isset($_POST["answer"])) {
                    ...
                    $name = $_SESSION['name'];
                    $ans = $_POST['answer'];
                    $sql = "UPDATE verifiedtable SET ans29 = '$ans' WHERE verified = '$name'";
                    if ($conn->query($sql) === TRUE) {
                        header('Location: question30.php');
                    }
                    else {
                        header('Location: question29.php');
                    }
                }
                ?>
            </div>
