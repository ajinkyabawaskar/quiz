...
<body>
    <div class="container mt-5">
        <div class="row">
            ...
            Name the e-commerce portal which the Union Government is planning to launch for MSME's for marketing and selling their products.
                ...
                if(isset($_POST["answer"])) {
                    ...
                    $name = $_SESSION['name'];
                    $ans = $_POST['answer'];
                    $sql = "UPDATE verifiedtable SET ans13 = '$ans' WHERE verified = '$name'";
                    if ($conn->query($sql) === TRUE) {
                        header('Location: question14.php');
                    }
                    else {
