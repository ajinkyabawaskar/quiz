...
<body>
    <div class="container mt-5">
        <div class="row">
            ...
            What is the growth rate predicted by United Nation’s World Economic Situation and Prospects Reports 2019 for India for the year 2018-19?
                ...
                if(isset($_POST["answer"])) {
                    ...
                    $name = $_SESSION['name'];
                    $ans = $_POST['answer'];
                    $sql = "UPDATE verifiedtable SET ans10 = '$ans' WHERE verified = '$name'";
